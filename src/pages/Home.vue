<template>
    <main>
        <base-post type="history">
            ...
            <p>I've always been curious about software development. I wouldn't say I have a specific field I'm interested in. Since I love playing Videogames, browsing the Web and, well, using Computers, I'm interested in all the different kinds of software.</p>
        ...
        <base-post type="briefcase">
            ...
            <p>That's also the reason why I've made this website. To show that I am a capable developer. And that I'm a good addition to your Team.</p>
            <hr>
